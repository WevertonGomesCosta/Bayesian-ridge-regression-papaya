...
The next step fits BRR, BayesA, BayesB, BayesB with the specified
zero-effect probability, BayesC, Bayesian Lasso, RR-BLUP, and GBLUP using the
same five validation folds. For every fold, only the phenotype vector is
masked; `X`, `M`, and `G` remain unchanged.
