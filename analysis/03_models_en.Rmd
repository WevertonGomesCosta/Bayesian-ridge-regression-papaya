...
The outputs accumulated during fitting are combined into single tables.
...
## 12. Saving the outputs

The results used by the following modules are written after all 350 fits have
been completed.
