...
# Build the recurrence distribution object.
...
# Build the model comparison display object.
...
# Build the predictive plot object.
...
# Build the final results summary object.
...
```{r selected-mu-data}
# Build the burn in saved object.
burn_in_saved <-
...
for (trait_index in seq_along(traits)) {
  ...
  # Build the density object object.
...
# Build the selected mu density object.
...
# Build the fold stability display object.
...
# Build the correlation long object.
...
# Build the selection sizes display object.
...
# Build the recurrence class labels object.
...
# Build the main multitrait candidates object.
