...
candidates eligible for automatic selection.
...
largest oriented score are selected. For traits whose objective is to
...
Recurrence is descriptive: it counts the supported traits for which each
