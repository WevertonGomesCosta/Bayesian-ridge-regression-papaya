...
# Build the pooled metrics object.
...
```{r model-comparison}
# Build the model comparison object.
...
```{r selection-winners}
# Build the DIC COMPETITIVE THRESHOLD object.
...
# Build the model selection support object.
...
# Build the automatic selections object.
...
# Build the selected performance object.
...
# Build the model selection object.
...
```{r runtime}
# Build the runtime summary object.
...
# Build the rrblup variance components object.
...
# Build the rrblup heritability by fold object.
...
# Build the selection objective map object.
...
```{r genomic-ranking}
# Build the genomic ranking object.
...
# Build the recurrence counts object.
...
# Build the multitrait recurrence object.
