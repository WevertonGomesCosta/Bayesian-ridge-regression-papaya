...
# Require complete and unique OOF coverage before recomputing performance.
stopifnot(
...
# Require exactly one valid selected method for every trait.
stopifnot(
...
# Confirm that the final decision table preserves one valid selection per trait.
stopifnot(
...
# Require the proportional ranking to retain exactly the declared number of unique candidates.
stopifnot(
