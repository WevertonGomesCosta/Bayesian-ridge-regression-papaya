...
The table below places Bayesian fit and OOF performance side by side. `Mean_DIC`, `Delta_DIC`, `Wprob`, and `ER` should be compared only among methods for the same trait; `r`, RMSE, and MAE describe OOF predictive performance. Similarity in DIC does not replace predictive evidence.
