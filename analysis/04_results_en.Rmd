...
The tolerances are derived from the method with the largest mean correlation and the method with the smallest mean RMSE. A method must satisfy both correlation and RMSE tolerances to be classified as predictively competitive.
...
format_table(
  ...
  col.names = c("Trait", "Selected method", "Predictive winner", "DIC winner", "r", "p-value", "RMSE", "Mean DIC", "Delta DIC", "RR-BLUP preference applied", "Selection status", "OOF predictive direction", "OOF nominal signal")
)
# DISPLAY-ONLY END
```
