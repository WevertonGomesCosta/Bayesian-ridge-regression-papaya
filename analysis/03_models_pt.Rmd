...
data.frame(
  ...
  # Organiza o componente `Estrutura` desta estrutura.
  Estrutura = c(
...
ETA_models <- list(
  ...
  BayesB = list(
    fixed = family_term,
    # Organiza o componente `genomic` desta estrutura.
...
for (run_index in seq_len(nrow(run_design))) {
  ...
  # Cria `fit` para uso nas etapas seguintes deste bloco.
  ...
  metric_parts[[run_index]] <- data.frame(
    ...
    # Organiza o componente `Posterior_mean_SD` desta estrutura.
...
data.frame(
  ...
  # Organiza o componente `Linhas` desta estrutura.
  Linhas = c(
...
# Cria `model_catalogue` para uso nas etapas seguintes deste bloco.
model_catalogue <- data.frame(
  ...
  # Organiza o componente `Genomic_input` desta estrutura.
