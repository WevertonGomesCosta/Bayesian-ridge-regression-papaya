...
# Cria `method_labels` para uso nas etapas seguintes deste bloco.
method_labels <- c(
  RRBLUP = "RR-BLUP/BRR",
  BayesA = "BayesA",
  BayesB = "BayesB",
...
# Cria `method_colors` para uso nas etapas seguintes deste bloco.
method_colors <- c(
  RRBLUP = "#3366CC",
  BayesA = "#DC3912",
  BayesB = "#FF9900",
...
for (trait_index in seq_along(traits)) {
  ...
  # Cria `density_object` para uso nas etapas seguintes deste bloco.
...
# Cria `correlation_long` para uso nas etapas seguintes deste bloco.
...
# Cria `correlation_plot` para uso nas etapas seguintes deste bloco.
correlation_plot <- ggplot(
  ...
  scale_fill_gradient2(
    ...
    high = "#3366CC",
    midpoint = 0,
    # Organiza o componente `limits` desta estrutura.
    limits = c(-1, 1)
  ) +
  labs(
    x = NULL,
