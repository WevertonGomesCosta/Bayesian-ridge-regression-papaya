...
# Constrói o objeto recurrence distribution.
...
# Constrói o objeto model comparison display.
...
# Constrói o objeto predictive plot.
...
# Constrói o objeto final results summary.
...
```{r selected-mu-data}
# Constrói o objeto burn in saved.
burn_in_saved <-
...
for (trait_index in seq_along(traits)) {
  ...
  # Constrói o objeto density object.
...
# Constrói o objeto selected mu density.
...
# Constrói o objeto fold stability display.
...
# Constrói o objeto runtime plot.
...
# Constrói o objeto correlation long.
...
# Constrói o objeto selection sizes display.
...
# Constrói o objeto recurrence class labels.
...
# Constrói o objeto main multitrait candidates.
