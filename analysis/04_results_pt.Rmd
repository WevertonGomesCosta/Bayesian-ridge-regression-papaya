...
# Constrói o objeto pooled metrics.
...
```{r model-comparison}
# Constrói o objeto model comparison.
...
```{r selection-winners}
# Constrói o objeto DIC COMPETITIVE THRESHOLD.
...
# Constrói o objeto model selection support.
...
# Constrói o objeto automatic selections.
...
# Constrói o objeto selected performance.
...
# Constrói o objeto model selection.
...
```{r runtime}
# Constrói o objeto runtime summary.
...
# Constrói o objeto rrblup variance components.
...
# Constrói o objeto rrblup heritability by fold.
...
# Constrói o objeto selection objective map.
...
```{r genomic-ranking}
# Constrói o objeto genomic ranking.
...
# Constrói o objeto recurrence counts.
...
# Constrói o objeto multitrait recurrence.
