...
data.frame(
  ...
  tabela_html(caption = "Resultados recebidos do ajuste dos modelos")
```
...
selection_spec |>
  ...
  tabela_html(caption = "Método escolhido após a aplicação da regra hierárquica")
```
