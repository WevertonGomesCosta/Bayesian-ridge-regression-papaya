...
data.frame(
  ...
  # Organiza o componente `Caracteristicas` desta estrutura.
  Caracteristicas = c(
...
selection_spec <- predictive_winners |>
  ...
  left_join(
    ...
    # Organiza o componente `by` desta estrutura.
...
# Cria `selected_individuals_by_trait` para uso nas etapas seguintes deste bloco.
