...
A tabela abaixo coloca lado a lado ajuste Bayesiano e desempenho OOF. `Mean_DIC`, `Delta_DIC`, `Wprob` e `ER` devem ser comparados somente entre métodos da mesma característica; `r`, RMSE e MAE descrevem o desempenho preditivo OOF. A proximidade em DIC não substitui a evidência preditiva.
